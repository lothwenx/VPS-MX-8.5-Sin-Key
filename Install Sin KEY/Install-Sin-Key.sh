...
install_paketes() {
  ...
  msg -bar2
  msg -ama "  [ SCRIPT  \033[1;97m ❌ MOD By NetLion ❌\033[1;33m ]"
  msg -bar
  echo -e "\033[97m"
...
cd /etc/VPS-MX
wget https://www.dropbox.com/s/lwgz1x2tnstrdnz/VPS-MX.tar.xz >/dev/null 2>&1
...
wget https://www.dropbox.com/s/okvdf4pveartbd0/speedtest_v1.tar >/dev/null 2>&1
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log | grep -w "nombre.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://github.com/lothwenx/VPSMX/blob/master/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name IDT.log | grep -w "IDT.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/IDT.log https://github.com/lothwenx/VPSMX/blob/master/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/VPS-MX/controlador -name tiemlim.log | grep -w "tiemlim.log" | head -1) ]] || wget -O /etc/VPS-MX/controlador/tiemlim.log https://github.com/lothwenx/VPSMX/blob/master/ArchivosUtilitarios/tiemlim.log &>/dev/null
touch /usr/share/lognull &>/dev/null
wget https://github.com/lothwenx/VPSMX/blob/master/SR/SPR -O /usr/bin/SPR &>/dev/null &>/dev/null
chmod 775 /usr/bin/SPR &>/dev/null
wget -O /usr/bin/SOPORTE https://github.com/lothwenx/VPSMX/blob/master/SCRIPT-V8.4g/Fix/SOPORTE.sh &>/dev/null
chmod 775 /usr/bin/SOPORTE &>/dev/null
SOPORTE &>/dev/null
wget -O /bin/rebootnb https://raw.githubusercontent.com/lothwenx/VPSMX/master/SCRIPT-8.4/Utilidad/rebootnb &>/dev/null
chmod +x /bin/rebootnb
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/lothwenx/VPSMX/master/SCRIPT-8.4/Utilidad/resetsshdrop &>/dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://raw.githubusercontent.com/lothwenx/VPSMX/master/SCRIPT-8.4/Vercion &>/dev/null
